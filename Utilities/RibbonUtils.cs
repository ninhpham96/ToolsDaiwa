...
namespace Tools.Utilities
{
    public static class RibbonUtils
    {
        ...
        public static RibbonPanel? CreatePanel(UIControlledApplication a, string panelName)
        {
            RibbonPanel ribbonPanel = null;
            foreach (var panel in a.GetRibbonPanels(Tab.AddIns))
            {
            ...
            return ribbonPanel ?? a.CreateRibbonPanel(panelName);
        }
        /// <summary>
